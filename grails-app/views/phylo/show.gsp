...
<html>
	...
	<body>
		<a href="#show-phylo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-phylo" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:phyloInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${phyloInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
