<div>
    <div class="bs-callout" id="uploadCharacters" style="position: relative">
        <h4 style="cursor:pointer" id="uploadCharactersTitle" data-bind="click: onClick"><i
                class="icon icon-chevron-down"></i> <a>Upload your character data</a></h4>
            ...
            <form id="csvForm" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <label><a data-bind="attr{href:sampleCSV}"
                                  target="_blank">Download sample CSV file from here.</a></label>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="title" data-bind="value: title" placeholder="My acacia characters"
                               required>
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label" for="sciName">Column with scientific name*:</label>

                    <div class="controls">
                        <select id="sciName"
                                data-bind="options:headers,optionsText:'displayname',value:selectedValue,optionsCaption:'Choose..'"
                                required></select>
                    </div>
                </div>
...
<div id="charactermain">
    <div class="bs-callout" style="position: relative" id="pickFromList">
        ...
        <form id="sourceToolbar" class="form-horizontal">
            <div class="control-group">
                <label class="control-label" for="sourceChar">List of characters available:</label>

                <div class="controls">
                    <select id="sourceChar"
                            data-bind="options:lists,optionsText:'title',value:list,optionsCaption:'Choose..', event:{change:loadNewCharacters}"
                            required></select>
                </div>
            </div>
        </form>
    ...
    <div class="btn btn-xs btn-primary top-buffer offset4"
         data-bind="click: addCharacter, visible:list(), attr:{disabled:listLoading()}"><i
            class="icon-white icon-plus-sign"></i> Add Character to Tree</div>
