...
<div class="fieldcontain ${hasErrors(bean: phyloInstance, field: 'widgets', 'error')} row">
    <div class="span4">
        <g:message code="phylo.widget.pd.label" default="Summarize data for" />:
    </div>
    <div class="span4">
            ...
            <input type="text" id="widgets[ID].displayname" name="widgets[ID].displayname" readonly="true" value="Phylogenetic Diversity"/>
    </div>
</div>
</script>